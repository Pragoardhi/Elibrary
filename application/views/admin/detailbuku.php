                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary">Details <button class="btn btn-danger" style="float:right" onclick="location.href='<?= base_url() ?>Admin/Daftarbuku'">&times;</button> </h3>
                        </div>
                        <div class="card-body">
