                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary">Tipe Buku <button class="btn btn-primary" data-toggle="modal" data-target="#tambahModal" style="float:right">Tambah Tipe</button></h3>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="bookTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $count  = count($listtipe);

                                        for ($i = 0; $i < $count; $i++) {
                                            $number = $i + 1;
                                            echo '<tr>';
                                            echo '<td>' . $number . '</td>';
                                            echo '<td>' . $listtipe[$i]["Tipe"] . '</td>';
                                            ?>
